// ============================================================
// CoreInfrastructureTest.gs v2.0.0
//
// TaxControl ERP Core
//
...
console.log("CoreInfrastructureTest v2.0.0");
...
const CoreInfrastructureTest = {
  ...
  testSchemaRegistry(){
    ...
    if(schema.system!==true){
      ...
      throw new Error(
        "Test schema is not system schema"
      );
  ...
  testAdapter(){
    ...
    const sheet =
      SpreadsheetAdapter.getOrCreateSheet(
        this.TEST_SHEET
      );
  ...
  testChain(){
    ...
    if(!adapterRecord){
      ...
      throw new Error(
        "Chain Adapter persistence failed"
      );
    ...
    return {
      ...
      message:
      "SchemaRegistry → Database → SpreadsheetAdapter → Repository verified"
