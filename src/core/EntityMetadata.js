...
const EntityMetadata = {
  ...
  // ----- НОВАЯ СУЩНОСТЬ: TRANSPORT_ORDER (зарегистрирована через метод register) -----
  // (будет добавлена динамически ниже)
};
...
// ----- НОВЫЙ МЕТОД REGISTER (для динамической регистрации сущностей) -----
